    ...
    <div className="container mx-auto px-4 py-12 sm:py-16">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-12">
        ...
        <div className="md:col-span-4 bg-slate-800/50 p-4 sm:p-6 rounded-lg">
          <h4 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-orange-500">Proudly Veteran Owned</h4>
          <div className="flex items-center space-x-4">
            <div className="relative w-14 sm:w-20 h-14 sm:h-20 flex-shrink-0">
              <Image
