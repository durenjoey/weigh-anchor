...
export const clients: Client[] = [
  ...
  { id: 'akiachak', name: 'Akiachak Native Community', location: 'Akiachak', state: 'AK', coordinates: { lat: 60.91, lng: -161.43 }, category: 'Tribal Nation' },
  { id: 'angoon', name: 'Angoon Community Association', location: 'Angoon', state: 'AK', coordinates: { lat: 57.50, lng: -134.58 }, category: 'Tribal Nation' },
  ...
  { id: 'colusa', name: 'Colusa Indian Community', location: 'Colusa', state: 'CA', coordinates: { lat: 39.21, lng: -122.01 }, category: 'Tribal Nation' },
  { id: 'flandreau', name: 'Flandreau Santee Sioux Tribe', location: 'Flandreau', state: 'SD', coordinates: { lat: 44.05, lng: -96.60 }, category: 'Tribal Nation' },
  { id: 'fond-du-lac', name: 'Fond du Lac Band of Lake Superior Chippewa', location: 'Cloquet', state: 'MN', coordinates: { lat: 46.72, lng: -92.46 }, category: 'Tribal Nation' },
  { id: 'kiowa', name: 'Kiowa Tribe', location: 'Carnegie', state: 'OK', coordinates: { lat: 35.10, lng: -98.60 }, category: 'Tribal Nation' },
  { id: 'nooksack', name: 'Nooksack Indian Tribe', location: 'Deming', state: 'WA', coordinates: { lat: 48.82, lng: -122.21 }, category: 'Tribal Nation' },
  { id: 'poarch', name: 'Poarch Band of Creek Indians', location: 'Atmore', state: 'AL', coordinates: { lat: 31.02, lng: -87.49 }, category: 'Tribal Nation' },
  { id: 'port-gamble', name: "Port Gamble S'Klallam Tribe", location: 'Kingston', state: 'WA', coordinates: { lat: 47.80, lng: -122.50 }, category: 'Tribal Nation' },
  { id: 'saint-regis-mohawk', name: 'Saint Regis Mohawk Tribe', location: 'Akwesasne', state: 'NY', coordinates: { lat: 44.98, lng: -74.66 }, category: 'Tribal Nation' },
  { id: 'seminole-ok', name: 'Seminole Nation of Oklahoma', location: 'Wewoka', state: 'OK', coordinates: { lat: 35.16, lng: -96.49 }, category: 'Tribal Nation' },
  { id: 'skokomish', name: 'Skokomish Indian Tribe', location: 'Skokomish', state: 'WA', coordinates: { lat: 47.34, lng: -123.14 }, category: 'Tribal Nation' },
  { id: 'tulalip', name: 'Tulalip Tribes', location: 'Tulalip', state: 'WA', coordinates: { lat: 48.07, lng: -122.29 }, category: 'Tribal Nation' },
  // Federal Government
