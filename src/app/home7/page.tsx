...
export default function Home7() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0f13] text-zinc-300">
      ...
      <DarkNav logo="/assets/logos/weigh_anchor_logo_v2_white.png" logoHeight="h-14" />
      ...
      <footer className="py-12 border-t-2 border-zinc-800 bg-[#0a0c10]">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="grid lg:grid-cols-4 gap-8 mb-8">
            <div>
              <Link href="/home7" className="flex items-center gap-2 mb-4">
                <img
                  src="/assets/logos/weigh_anchor_logo_v2_white.png"
                  alt="Weigh Anchor"
