          ...
          <div className="flex items-center justify-between h-14">
            <Link href="/home4" className="flex items-center gap-3 group">
              <img
                ...
                alt="Weigh Anchor"
                className="h-7 w-auto brightness-0 invert group-hover:scale-105 transition-transform"
              />
            ...
            <nav className="hidden md:flex items-center gap-0">
              {[
                ...
                <Link key={item.href} href={item.href}>
                  <Button variant="ghost" size="sm" className="text-zinc-500 hover:text-white hover:bg-white/5 uppercase text-xs tracking-wider font-medium rounded-none">
                    {item.label}
                  </Button>
                </Link>
              ))}
              ...
              <Link href="/contact">
                <Button size="sm" className="bg-orange-600 text-white hover:bg-orange-500 font-bold uppercase text-xs tracking-wider rounded-sm">
                  Contact
                </Button>
              </Link>
            </nav>
